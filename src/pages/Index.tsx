      ...
      <footer className="glass-card py-12 px-4 mt-20">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <img src="/lovable-uploads/8f762cd9-7246-46af-a18d-a0cbda455145.png" alt="Horizon SABG" className="h-10 w-10 object-contain bg-white/10 rounded-lg p-1 backdrop-blur-sm" />
